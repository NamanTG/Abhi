...
from info import AUTH_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, IS_SHORTLINK, LOG_CHANNEL, TUTORIAL, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION, REACTIONS
...
# Reaction Function 
async def reactg(_, m: Message):
    try:
        await m.react(emoji=choice(REACTIONS), big=True)
    except (
        MessageIdInvalid,
        EmoticonInvalid,
        ChatAdminRequired,
