...
BOT_TOKEN = environ.get('BOT_TOKEN', "6510800717:AAGFYyR5pfq1obDGpLgmxcDBTQjmlk2h9IA")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/a52e64cda7001db4223e9.jpg https://graph.org/file/6a23a97de2f9a38a4c765.jpg https://graph.org/file/6baf34c26d7449a3d4230.jpg https://graph.org/file/b8872fd27fb460e8e41d1.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1667104725 1855665805').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002233004641').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002158842186') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://User:User@aabhi.9lafcjp.mongodb.net/")
DATABASE_NAME = environ.get('DATABASE_NAME', "MVP_Abhi")
...
MSG_ALRT = environ.get('MSG_ALRT', 'ɪ ᴀᴍ sʟɪɢʜᴛʟʏ ʙᴜsʏ ᴘʟᴇᴀsᴇ ᴡᴀɪᴛ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002144292299')) #Log channel id ( make sure bot is admin )
...
URL = "https://movie-stud-85aeb9631d48.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-stud-85aeb9631d48.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-stud-85aeb9631d48.herokuapp.com/".format(FQDN)
else:
    URL = "https://movie-stud-85aeb9631d48.herokuapp.com/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002144292299'))
