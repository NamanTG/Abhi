...
BOT_TOKEN = environ.get('BOT_TOKEN', "6510800717:AAFcILp4CgGy9zTgW3M7CgXZD4GclvoYQoU")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002337625310') #Channel / Group Id for force sub ( make sure bot is admin )
