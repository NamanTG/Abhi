...
from utils import get_settings, get_size, is_req_subscribed, save_group_settings, temp, verify_user, check_token, check_verification, get_token, get_shortlink, get_tutorial, reactg
...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    InlineKeyboardButton('☆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ☆', url=f'http://t.me/MovieStudioXBot?startgroup=true')
                ],[
                    InlineKeyboardButton('🍁 ʜᴏᴡ ᴛᴏ ᴜꜱᴇ 🍁', url="https://t.me/MovieStudioXBot?start=help")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await reactg(client, message)
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        btn = [
            [
                ...
                InlineKeyboardButton(
                    "Jᴏɪɴ", url="https://t.me/+2GXu1OFDJtw5Y2Y1")
            ]
        ]
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/Moviestudioabhi')
                            ]
                        ]
                    )
                )
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/Moviestudioabhi') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
